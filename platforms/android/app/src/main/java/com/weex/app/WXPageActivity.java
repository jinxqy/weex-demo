...
public class WXPageActivity extends AbsWeexActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGlobalEventModule.addEventListener("cam_finish", "cam_finish");
    ...
    public void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            requestPermissions(new String[] {Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERM_REQ_CODE);
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        map.put("data", "拍完了");
        mInstance.fireGlobalEventCallback("cam_finish", map);
